...
class MyUserChangeForm(forms.ModelForm):
    class Meta:
        ...
        fields = ("username", "first_name", "last_name", "country",
                  "city", "gender", 'profile_photo', 'birthday')
        widgets = {
...
class LoginForm(forms.Form):
    username = forms.CharField(widget=forms.TextInput(), error_messages={
...
class Security(forms.Form):
    CurrentPassword = forms.CharField(
        widget=forms.PasswordInput(), label="Şifrə *")
    Newpassword = forms.CharField(
        widget=forms.PasswordInput(), label="Yeni Şifrə")
    ConfirmPassword = forms.CharField(
        widget=forms.PasswordInput(), label="Yeni Şifrə təkrar")
